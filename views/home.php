...
<form>
    ...
    <div class="relative">
        ...
        <input type="search" id="search" class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg    dark:border-gray-600 dark:placeholder-gray-400 dark:text-white " placeholder="Search" >
        <button type="submit" class="text-white absolute right-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button>
    </div>
</form>

<div class="">
    <section class="cover flex justify-center items-center bg-blue-teal-gradient relative px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 overflow-hidden py-48 flex
      items-center">
        <div class="h-full absolute top-0 left-0 z-0 right-0">
            <img src="asset/img/medical.jpg" alt="" class="w-full h-full object-cover opacity-20 mx-auto" >
        </div>

        <div class="lg:w-3/4 xl:w-2/4 relative z-10 h-100 lg:mt-16">
            <div>
                <h1 class="text-white text-4xl md:text-5xl xl:text-6xl font-bold leading-tight">A better life starts with a beautiful
                    smile.</h1>
...
<section class="relative  px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-32">
    <div class="flex flex-col md:flex-row lg:-mx-8">
        <div class="w-full lg:w-1/2 lg:px-8">
            <h6 class="text-sm uppercase font-semibold tracking-widest">Our clinic</h6>
    ...
    <div class="flex flex-col md:flex-row mt-24 text-center md:-mx-4">
        <div class="rounded-lg shadow-lg p-8 md:mx-4">
...
<section class="relative bg-blue-teal-gradient px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-8">
    <div class="flex items-center justify-center">
        ...
        <a href="#" class="px-8 py-4  text-blue-600 rounded inline-block font-semibold ml-8">Book Appointment</a>
    </div>
</section>